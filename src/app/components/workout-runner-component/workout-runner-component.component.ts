...
import { WorkoutHistoryTrackerService } from 'src/app/core/workout-history-tracker.service';



@Component({
  selector: 'app-workout-runner-component',
  templateUrl: './workout-runner-component.component.html',
  styleUrls: ['./workout-runner-component.component.css']
})
export class WorkoutRunnerComponentComponent implements OnInit {
  ...
  getNextExercise():ExercisePlan{
    ...
    else if(this.currentExerciseIndex == this.workoutPlan.exercises.length){
